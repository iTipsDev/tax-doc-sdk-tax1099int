# tax-doc-sdk-tax1099int

Software development kit to generate IRS Form 1099-INT as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099Int.sample.png" width="850"/>
