...
import org.taxdataexchange.docs.tax1099int.models.*;
import org.taxdataexchange.docs.tax1099int.utils.*;
...
public class Tax1099IntDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1099Int" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        String filePath = "samples/Tax1099Int.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1099Int.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1099Int.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1099Int.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1099Int.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
